...
public class MigrateTask39 {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MigrateTask39.class);
    ...
    private Domain selectVM() throws Exception {
        ...
        Connect conn = sourceConn.getConn(ServerInfoUtil.VmServerIp39);
        try{
