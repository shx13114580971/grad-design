...
public class CodeMsg {
	...
	public static CodeMsg EMPTY = new CodeMsg(500105,"不能为空");
	//登录模块 5002XX
	...
	public static CodeMsg MOBILE_EXIST = new CodeMsg(500215, "手机号已存在");
	...
	public static CodeMsg VM_RUNNING_ERROR = new CodeMsg(500302, "实验机运行异常");
