...
public class UserController {
    ...
    public Result<String> doDeliver(@RequestParam(name = "document", required=false) MultipartFile document,
        ...
        filePath1 = FileUtil.basic_path + "expDocuments\\";
        if(isProvideVm.equals("0"))filePath2 = FileUtil.basic_path + "deployDocuments\\";
        if(isProvideVm.equals("1"))filePath2 = FileUtil.basic_path + "vmImgs\\";
